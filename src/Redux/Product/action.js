...
export const getProducts = (params) => (dispatch) => {
  ...
  return axios("https://voguevista-server.onrender.com/products", params)
    .then((res) => {
...
export const getShoesProducts = () => (dispatch) => {
  // console.log(params)
  dispatch({ type: types.GET_PRODUCTS_REQUEST });
  return axios("https://voguevista-server.onrender.com/products/shoes")
    .then((res) => {
      dispatch({ type: types.GET_PRODUCTS_SUCCESS, payload: res.data });
    })
    .catch((err) => {
...
export const getDressesProducts = () => (dispatch) => {
  // console.log(params)
  dispatch({ type: types.GET_PRODUCTS_REQUEST });
  return axios("https://voguevista-server.onrender.com/products/dresses")
    .then((res) => {
      dispatch({ type: types.GET_PRODUCTS_SUCCESS, payload: res.data });
    })
    .catch((err) => {
...
export const deleteProducts = (id) => (dispatch) => {
  ...
  return axios
    .delete(`https://voguevista-server.onrender.com/products/${id}`)
    .then((res) => {
...
export const updateProducts = (id, payload) => (dispatch) => {
  ...
  return axios
    .patch(`https://voguevista-server.onrender.com/products/${id}`, payload)
    .then((res) => {
