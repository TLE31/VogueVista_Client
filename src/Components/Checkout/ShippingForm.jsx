...
const ShippingForm = () => {
  ...
  const handleCheckout = async () => {
    ...
    const {
      ...
      `https://voguevista-server.onrender.com/checkout/order/${localStorage.getItem(
        "userId"
      )}`,
      {
        amount,
    ...
    const options = {
      ...
      order_id: order.id,
      callback_url: `https://voguevista-server.onrender.com/checkout/order/${localStorage.getItem(
        "userId"
      )}/paymentverification`,
      prefill: {
